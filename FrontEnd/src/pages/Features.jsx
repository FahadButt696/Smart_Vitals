...
const featureData = [
  {
    ...
    image: workout,
    steps: ["📋 Select workout type", "💪 Log your reps and sets", "📊 Analyze performance growth"],
  },
  {
    ...
    steps: ["🍽️ Upload your meal photo", "📈 Get instant calorie count", "📊 Track nutritional balance"],
  },
  {
    ...
    steps: ["🎯 Set calorie goal", "🍱 Add meals daily", "📉 See how your day stacks up"],
  },
  {
    title: "Meal Logger",
    description:
    ...
    image: MealLogger,
    steps: ["🍕 Add meals instantly", "📷 Use camera or search", "📊 Monitor meal history"],
  },
  {
    ...
    image: AiMeal,
    steps: ["🤖 Enter preferences", "📝 Review suggested plan", "🥗 Follow tailored diet"],
  },
  {
    ...
    image: AiSymptom,
    steps: ["💬 Enter symptoms", "🤖 AI analysis begins", "📃 Receive suggestions"],
  },
  {
    ...
    image: AiMental,
    steps: ["🌞 Daily mood check", "🧠 Get support tips", "💬 Chat with AI bot"],
  },
  {
    title: "Sleep Tracker",
    description:
    ...
    image: SleepTracker,
    steps: ["🌙 Track bedtime", "⏰ Analyze sleep cycles", "🧘 Improve sleep quality"],
  },
  {
  ...
  },
  {
    ...
    image: water,
    steps: ["💧 Set water goal", "🕒 Log each intake", "📊 Check hydration level"],
  },
  {
  ...
  },
  {
    ...
    image: Chart,
    steps: ["📊 See health insights", "📈 Analyze trends", "📤 Share visual data"],
  },
];
...
>
  ...
  <motion.p
    ...
    variants={textVariants}
  >
    Discover how Smart Vitals uses AI to help you live healthier.
    From calorie tracking to mental health support, everything is crafted
    to make your wellness journey seamless.
  </motion.p>
</motion.div>
