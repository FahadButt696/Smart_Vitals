...
import {
  ...
  dark11, dark12, dark13, dark14, dark15, dark16, dark17, dark18, dark19,
  dark20, dark21, dark22, dark23, dark24, dark25, dark26, dark27, dark28,
  dark29, dark30, dark31
} from "@/assets/Assets";

export function ThreeDMarqueeDemoSecond() {
  const images = [
    dark1, dark2, dark3, dark4, dark5, dark6, dark27, dark8, dark9, dark10,
    dark11, dark12, dark13, dark14, dark15, dark17, dark18, dark19, dark20,
    dark21, dark22, dark23, dark24, dark25, dark26, dark7, dark28, dark29,
    dark30, dark31,
  ];
