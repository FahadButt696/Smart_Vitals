        ...
        <div className="relative flex w-full z-0">
          {isSignIn ? (
            <div className="w-1/2 p-8 pt-14">
              ...
              <SignUp path="/Signup" routing="path" signInUrl="/Login" fallbackRedirectUrl="/Home"
              className="bg-amber-300"/>
            </div>
          ) : (
            <div className="w-1/2 p-8 pt-14">
              <h2 className="text-2xl font-bold text-cyan-800 mb-6">Sign Up</h2>
              <SignIn className="bg-amber-300" path="/Login" routing="path" signUpUrl="/Signup" fallbackRedirectUrl="/Home"/>
