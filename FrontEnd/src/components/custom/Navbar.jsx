...
export const MobileNavToggle = ({ isOpen, onClick }) => {
  return isOpen ? (
    ...
    <IconMenu2 className="text-white dark:text-white" onClick={onClick} size={24} />
  );
};
...
export const NavbarButton = ({
  ...
  const variantStyles = {
    ...
    secondary: "bg-transparent border border-white text-white dark:text-white hover:bg-white/10",
